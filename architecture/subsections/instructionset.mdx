...
description: "Custom instruction set designed for MPC with efficient handling of clear and secret value domains."
---
...
- `RET(reg)`:
  Restores the caller execution context and provides a return value.
