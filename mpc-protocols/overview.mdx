...
description: "HoneyBadger MPC protocol overview with Byzantine fault tolerance for secure multi-party computation in Stoffel."
---
...
Stoffel VM supports arithmetic operations directly on secret-shared values:
...
- **Connection resilience**: Handles network changes gracefully
...
- [Stoffel VM](../stoffel-vm/overview): How the VM executes MPC programs
