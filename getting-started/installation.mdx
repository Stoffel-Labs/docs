...
If you use an AI coding agent, paste this prompt into your agent. It tells the agent to install the `stoffel` CLI binary, install the Stoffel skills, connect docs access, and verify the setup before writing code:
