...
description: "Detailed Stoffel VM architecture including dual register spaces for clear and secret values in MPC operations."
---
...
![Stoffel VM execution model showing bytecode, the instruction dispatcher, clear registers, secret registers, runtime stores, and MPC protocol hooks.](/images/diagrams/vm-execution-model.svg)
