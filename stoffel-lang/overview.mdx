...
If an AI coding agent is writing or changing `.stfl` source, keep this page as the language reference and point the agent to [Stoffel-Lang App Programming](/developer-skills/stoffel-lang-app-programming). For private inputs, `ClientStore`, or client outputs, also use [Stoffel Secret MPC Programming](/developer-skills/stoffel-secret-mpc-programming).
