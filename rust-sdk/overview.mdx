...
description: "High-level Rust API for building MPC applications, bridging StoffelLang, StoffelVM, and HoneyBadger protocol."
---
...
- **[Installation](./installation)**: Set up the Rust SDK
- **[API Reference](./api)**: Complete API documentation
- **[Examples](./examples)**: Working code examples
- **[StoffelLang](../stoffel-lang/overview)**: Learn the computation language
