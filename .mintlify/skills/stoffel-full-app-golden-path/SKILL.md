...
10. Prove the app in a clean-room environment.
...
2. run the verification ladder for every delivered layer; and
3. capture the clean environment description, dependency-resolution output, commands, exit status, and relevant test or smoke output.
