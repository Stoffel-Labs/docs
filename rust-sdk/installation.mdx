---
title: "Installation"
description: "Install the 0.1.0 CLI and add the Rust SDK to an application."
---

# Rust SDK Installation

The Rust SDK is the primary application API for Stoffel 0.1.0. Its Cargo package is `stoffel-rust-sdk`, and the library crate you import in Rust code is `stoffel`.

<Note>
**Stoffel 0.1.0 Rust SDK**

Use the released CLI installer for project commands, then add the Rust SDK dependency shown below for applications and integrations.
</Note>

## Prerequisites

- Rust and Cargo, latest stable recommended
- The released `stoffel` CLI
- A local or git checkout of [`Stoffel-Labs/stoffel`](https://github.com/Stoffel-Labs/stoffel) if you want the SDK source or local MPC runner
- `stoffel-run` built if you want local MPC execution
...
For local MPC execution, also build the runner from source:
...
Use this while developing against the same checkout you built:
