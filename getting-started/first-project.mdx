...
description: "Build a complete real-world privacy-preserving salary benchmarking system using Stoffel and secure multi-party computation."
---
...
<Note>
The integrated `stoffel test` command is under development. For now, compile and run test files manually.
</Note>
...
1. **[Explore Advanced Features](../cli/development)**: Learn about advanced development workflows
2. **[Optimize Performance](../stoffel-vm/usage)**: Understand VM optimization techniques
3. **[Production Deployment](../cli/building)**: Deploy to real MPC networks
4. **[Community Templates](../cli/project-management)**: Explore more use case templates
