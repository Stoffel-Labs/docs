...
Use it after the [private matchmaking app](./private-matchmaking) when you want to understand private state transitions in isolation.
...
After this focused tutorial, return to [Build a private matchmaking service](./private-matchmaking) to see how private computation fits into a Rust service. Use [Private lottery reveal boundary](./private-lottery) for the smaller “one opened result” mental model.
