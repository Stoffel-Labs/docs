...
If an AI coding agent is integrating Rust application code, keep this page as the SDK reference and point the agent to [Stoffel Rust App SDK](/developer-skills/stoffel-rust-app-sdk) for task order, local MPC validation, and common integration pitfalls.
