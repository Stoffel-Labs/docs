...
description: "Use the Stoffel CLI to create, check, build, run, and iterate on private-computation projects."
---

# Stoffel CLI Overview

The `stoffel` CLI is the entry point for building with Stoffel. Use it to create projects, check source, build bytecode, run local checks, and exercise local MPC flows.
