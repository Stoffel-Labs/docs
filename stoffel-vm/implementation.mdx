...
![Stoffel VM execution model showing bytecode loading, instruction dispatch, clear and secret register spaces, runtime stores, builtins, and MPC hooks.](/images/diagrams/vm-execution-model.svg)
