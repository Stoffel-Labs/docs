...
description: "StoffelVM standard library reference including print, array operations, and the ClientStore API for MPC computations."
---
...
See the [Architecture - FFI](../architecture/subsections/foreignfunctioninterface) section for details on implementing custom builtins.
