...
| AVSS | Computational AVSS backend for verifiable scalar shares, public commitments, and curve-compatible outputs. | `avss`, `avss:<curve>` / `MpcBackend::Avss { curve }` |
...
| AVSS | Asynchronous verifiable secret sharing with Feldman-style commitments. Computational security under discrete-log assumptions; best suited to high-entropy scalar secrets that need commitments or curve-compatible outputs. |
