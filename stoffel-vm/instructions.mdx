...
description: "Complete Stoffel VM instruction set reference including memory operations, arithmetic, control flow, and bytecode format."
---

Stoffel VM is a register-based virtual machine optimized for Multi-Party Computation. This page documents the complete instruction set and type system.
...
Compiled programs currently use the `.stflb` extension:
