...
<Note>
Using an AI coding agent? Use the agent setup prompt below. It installs the `stoffel` CLI, installs Stoffel skills, connects docs access, and verifies the setup before the agent writes code.
</Note>
