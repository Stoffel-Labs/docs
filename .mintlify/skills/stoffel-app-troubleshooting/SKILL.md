...
>
> Dependency assumption: use current public crates.io releases by default, then an official GitHub tag/release or full immutable revision. A local checkout is a separate, explicitly requested, nonportable framework-development workflow.
