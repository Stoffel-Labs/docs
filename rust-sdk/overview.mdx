...
![Rust SDK runtime paths from Rust application code through compile/load APIs into clear local execution, local MPC execution, and network handles.](/images/diagrams/rust-sdk-runtime-paths.svg)

![Campaign-style Stoffel workflow diagram showing how source programs, the build contract, coordinator-managed runtime, and application clients connect.](/images/campaign/stoffel-how-it-works.png)
...
For a complete app-shaped project, use the [Rust SDK quickstart](../tutorials/rust-sdk-quickstart). It adds domain types, client-owned private payloads, a repository boundary, tests, and a runnable service around the same SDK pattern.

## Next steps

- [Install the Rust SDK](./installation)
- [Run the Rust SDK quickstart](../tutorials/rust-sdk-quickstart)
