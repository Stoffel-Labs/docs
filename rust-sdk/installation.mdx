---
title: "Installation"
description: "Install the 0.1.0 Rust SDK from the StoffelVM repository."
---
...
Use the source dependency shown below for 0.1.0 applications and integrations.
</Note>

## Prerequisites

- Rust and Cargo, latest stable recommended
- A local or git checkout of [`Stoffel-Labs/StoffelVM`](https://github.com/Stoffel-Labs/StoffelVM)
- `stoffel-run` built if you want local MPC execution

Build the repository and runner:
