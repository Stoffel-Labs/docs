...
<Note>
Using an AI coding agent? Install the CLI first, then use the optional agent setup below to add Stoffel skills and live docs access. Keep the main CLI docs as the source of truth; use the skills as the agent's task playbooks.
</Note>
