...
description: "Complete Stoffel system architecture showing how CLI, compiler, VM, SDKs, and MPC protocols interact."
---
...
![Campaign-style Stoffel architecture diagram showing developer application code, build artifacts, coordinator-managed execution, VM parties, and authorized outputs.](/images/campaign/stoffel-how-it-works-architecture.png)
...
![Campaign-style networked privacy backend diagram showing clients, coordinator, preprocessing, party mesh, and encrypted or authorized outputs.](/images/campaign/stoffel-networked-privacy-backend.png)
