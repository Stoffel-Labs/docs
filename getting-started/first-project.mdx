...
![Campaign-style Stoffel how-it-works diagram showing the source, build, runtime, and client output path for the first-project workflow.](/images/campaign/stoffel-how-it-works.png)
