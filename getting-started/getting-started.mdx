---
title: "Getting Started with Stoffel VM"
description: "Quick introduction to Stoffel VM, a register-based virtual machine built in Rust and optimized for multiparty computation."
---
...
### Installation
Stoffel VM is available on crates.io for Rust projects. Add it to your `Cargo.toml`:
...
## Further Reading
- Check the [examples](https://github.com/Stoffel-Labs/stoffel/tree/main/examples) directory for more complex programs
- Review the [test cases](https://github.com/Stoffel-Labs/stoffel/blob/0e8543c2c9953dfd9d309af56258e2df1130c106/src/core_vm.rs#L542) for implementation details
- Explore the [hook system](https://github.com/Stoffel-Labs/stoffel/blob/0e8543c2c9953dfd9d309af56258e2df1130c106/src/core_vm.rs#L2187) for debugging
