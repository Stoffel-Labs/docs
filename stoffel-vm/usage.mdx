---
title: "Using the VM"
description: "Running compiled StoffelLang programs with StoffelVM, including command-line options, debugging, and MPC integration."
---
...
- Requires network configuration (see [Rust SDK](../rust-sdk/overview))
...
- [Built-in Functions](./builtins): Reference for available builtins
- [Instructions](./instructions): Complete instruction set documentation
- [Rust SDK](../rust-sdk/overview): Integrate with Rust applications
- [MPC Protocols](../mpc-protocols/overview): Understand the underlying cryptography
