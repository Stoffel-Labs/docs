...
description: "Modern programming language for MPC applications with familiar syntax inspired by Rust and Python, featuring native secret types and strong typing."
---
...
- **[Syntax and Examples](./syntax)**: Detailed syntax guide with examples
- **[Compilation](./compilation)**: Understanding the compilation process