...
For advanced MPC workloads, use the preprocessing warning as a signal to inspect the circuit shape. The backend comparison page has the cross-backend version of this guidance in [Performance and circuit-shaping guidance](./overview#performance-and-circuit-shaping) and explains how [type choices affect preprocessing demand](./overview#type-choices-and-preprocessing-demand); for HoneyBadgerMPC, start with these checks:
