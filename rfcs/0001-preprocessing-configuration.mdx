...
**None expected.** The behavior is scoped to the documented 0.1.0 configuration model:
...
- If program is provided but preprocessing is explicitly set to explicit defaults (10, 20), emit deprecation warning suggesting removal of explicit values
