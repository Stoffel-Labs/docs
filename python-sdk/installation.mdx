...
Use the `StoffelVM` repository and the CLI Python template for Python-oriented project scaffolding. Use the Rust SDK for verified application execution.
</Note>

## Prerequisites

Install the 0.1.0 CLI from the matching `StoffelVM` release checkout first:
