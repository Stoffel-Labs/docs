...
If you want a complete minimal project before reading the pattern, run the [Rust SDK quickstart](https://github.com/Stoffel-Labs/Stoffel-tutorials/tree/main/tutorials/00-rust-sdk-quickstart). It is the smallest app-shaped Rust example before the larger tutorial apps.
