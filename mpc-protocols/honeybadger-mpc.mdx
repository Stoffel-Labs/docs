...
For advanced MPC workloads, use the preprocessing warning as a signal to inspect multiplication count, multiplication depth, type choices, and reveal boundaries. See [Performance and circuit shaping](./performance-and-circuit-shaping#honeybadgermpc-preprocessing-intuition) for the full checklist.
