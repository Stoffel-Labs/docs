...
![Compilation pipeline from StoffelLang source through parsing, type checking, lowering, optimization, and .stflb bytecode.](/images/diagrams/compilation-pipeline.svg)
