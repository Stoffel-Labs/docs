---
title: "Architecture"
description: "Technical overview of Stoffel VM's register-based architecture with separate clear and secret value handling."
---
...
![Stoffel VM execution model showing bytecode, the instruction dispatcher, clear and secret registers, runtime stores, and MPC protocol hooks.](/images/diagrams/vm-execution-model.svg)

![Campaign-style Stoffel stack diagram showing how applications, SDKs, Stoffel language and CLI, VM bytecode, and the privacy backend layer together.](/images/campaign/stoffel-stack.png)
