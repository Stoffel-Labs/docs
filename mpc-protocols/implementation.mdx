...
description: "How Stoffel carries MPC backend selection through bytecode, the VM, local runs, and SDK network/client configuration."
---

Stoffel records the selected MPC backend in the compiled program and carries it through the CLI, Rust SDK, VM, and network/client layers. This page explains that integration boundary. For the developer-facing protocol differences, start with [MPC Protocols](./overview).
